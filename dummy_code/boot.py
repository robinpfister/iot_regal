...
from dummy_bme import BME
from dummy_fan import Fan
from dummy_flowsensor import Flowsensor
from dummy_illumination import Illumination
from dummy_luminosity import Luminosity
from dummy_water_temperature import WaterTemperature
...
bme_left = BME(i2c_1, "address")
bme_right = BME(i2c_1, "address 2")
sensor_list = {
    ...
    "Rack/Air/Temperature/Top/Left": BMETemp(bme_left),
    "Rack/Air/Temperature/Top/Right": BMETemp(bme_right),
    "Rack/Air/Humidity/Top/Left": BMEHumidity(bme_left),
    "Rack/Air/Humidity/Top/Right": BMEHumidity(bme_left),
    ...
    "Rack/Air/VOC/Top/Left": BMEVocVsc(bme_left),
    "Rack/Air/VOC/Top/Right": BMEVocVsc(bme_right),
